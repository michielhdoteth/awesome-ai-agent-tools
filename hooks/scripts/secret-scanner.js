#!/usr/bin/env node
/**
 * Secret Scanner - PreToolUse Hook for Write|Edit
 * Scans for leaked secrets before writing/editing files.
 *
 ...
 *       {
 *         "matcher": "Write",
 *         "hooks": [{ "type": "command", "command": "node /path/to/secret-scanner.js" }]
 *       },
 *       {
 *         "matcher": "Edit",
 *         "hooks": [{ "type": "command", "command": "node /path/to/secret-scanner.js" }]
