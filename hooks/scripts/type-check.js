#!/usr/bin/env node
/**
 * Type Check - PostToolUse Hook for Write|Edit
 * Runs TypeScript type checking after writing/editing .ts/.tsx files.
 *
 ...
 *       {
 *         "matcher": "Write",
 *         "hooks": [{ "type": "command", "command": "node /path/to/type-check.js" }]
 *       },
 *       {
 *         "matcher": "Edit",
 *         "hooks": [{ "type": "command", "command": "node /path/to/type-check.js" }]
