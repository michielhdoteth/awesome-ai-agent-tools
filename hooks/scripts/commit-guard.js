#!/usr/bin/env node
/**
 * Commit Guard - PreToolUse Hook for Bash
 * Validates conventional commit message format before git commit.
 *
 ...
 *     "PreToolUse": [{
 *       "matcher": "Bash",
 *       "hooks": [{ "type": "command", "command": "node /path/to/commit-guard.js" }]
 *     }]
 *   }
 * }
 */
